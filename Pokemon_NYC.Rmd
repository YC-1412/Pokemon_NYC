...
```{r}
# preselect a small region around New York, because the for loop for maping lat and lng to states takes long
...
# rarity calculation: sum up all the appearing time all over NY. <30mins: rare, 30-60mins: uncommon, 60mins: common
